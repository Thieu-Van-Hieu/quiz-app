...
extension SubjectQueryWhereSort on QueryBuilder<Subject, Subject, QWhere> {
  ...
  QueryBuilder<Subject, Subject, QAfterWhere> anyCode() {
    return QueryBuilder.apply(this, (query) {
...
extension SubjectQueryWhere on QueryBuilder<Subject, Subject, QWhereClause> {
  ...
  QueryBuilder<Subject, Subject, QAfterWhereClause> codeGreaterThan(
    String code, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterWhereClause> codeLessThan(
    String code, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterWhereClause> codeBetween(
    String lowerCode,
    String upperCode, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Subject, Subject, QAfterWhereClause> codeStartsWith(
      String CodePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'code',
  ...
  QueryBuilder<Subject, Subject, QAfterWhereClause> codeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'code',
        value: [''],
  ...
  QueryBuilder<Subject, Subject, QAfterWhereClause> codeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension SubjectQueryLinks
    on QueryBuilder<Subject, Subject, QFilterCondition> {
  QueryBuilder<Subject, Subject, QAfterFilterCondition> quizzes(
      FilterQuery<Quiz> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> quizzesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> quizzesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'quizzes', 0, true, 0, true);
    });
  }

  QueryBuilder<Subject, Subject, QAfterFilterCondition> quizzesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'quizzes', 0, false, 999999, true);
    });
  }

  QueryBuilder<Subject, Subject, QAfterFilterCondition> quizzesLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subject, Subject, QAfterFilterCondition> quizzesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
